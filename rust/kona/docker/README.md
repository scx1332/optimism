...
docker pull ghcr.io/ethereum-optimism/kona/kona-node:nightly
docker pull ghcr.io/ethereum-optimism/kona/kona-host:nightly
docker pull ghcr.io/ethereum-optimism/kona/kona-supervisor:nightly

# Pull a specific date's nightly build
docker pull ghcr.io/ethereum-optimism/kona/kona-node:nightly-2024-12-10
```
