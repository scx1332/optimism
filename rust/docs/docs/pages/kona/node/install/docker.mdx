...
```bash
docker pull ghcr.io/ethereum-optimism/kona/kona-node
```
...
```bash
docker pull ghcr.io/ethereum-optimism/kona/kona-node:v0.1.0
```
</Callout>
...
```bash
docker run --rm ghcr.io/ethereum-optimism/kona/kona-node --version
```
